...
export class EmployeesController {
  ...
  addProduct(
    ...
    const empId = this.employeesService.insertEmployee(
      empName,
      lastName,
      empRole,
    );
  ...
  getOneEmployee(@Param('id') empId: string) {
    //@param se usa para guardar como parametro lo que venga despues de /employees
